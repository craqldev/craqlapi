...
property
	...
	|   ID PERIOD NEXTNODE LEFT_PAREN RIGHT_PAREN -> ^(VAR_NAME ID ^(NEXTNODE))
	|   ID PERIOD FIRSTCHILD LEFT_PAREN RIGHT_PAREN -> ^(VAR_NAME ID ^(FIRSTCHILD))
	;
...
function
	...
	|   MAPGET LEFT_PAREN variable COMMA variable RIGHT_PAREN -> ^(MAPGET variable variable)
	|   MAP LEFT_PAREN variable COMMA variable COMMA variable RIGHT_PAREN -> ^(MAP variable variable variable)
	;
